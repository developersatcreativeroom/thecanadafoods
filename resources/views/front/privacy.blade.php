        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-content">
                    <h2 class="mb-2 text-center">Privacy Policy</h2>
                    <nav>
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item fw-bold" aria-current="page">Last updated April 12, 2025</li>
                        </ol>
                    </nav>
                </div>
...
<section class="">
    ...
    <div class="bg-white p-4 rounded shadow-sm">
      ...
      <p>This Privacy Policy for Warrior Retail Inc. (doing business as The Canada Foods) ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:</p>

      <ul>
        <li>Visit our website at <a href="https://thecanadafoods.com" target="_blank">https://thecanadafoods.com</a>, or any website of ours that links to this Privacy Policy</li>
        <li>Engage with us in other related ways, including any sales, marketing, or events</li>
      </ul>

      <p><strong>Questions or concerns?</strong> Reading this Privacy Policy will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:support@thecanadafoods.com">support@thecanadafoods.com</a>.</p>
      ...
      <ul>
        <li><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. <em>Learn more about personal information you disclose to us.</em></li>
        <li><strong>Do we process any sensitive personal information?</strong> Some of the information may be considered "special" or "sensitive" in certain jurisdictions, for example your racial or ethnic origins, sexual orientation, and religious beliefs. <em>We do not process sensitive personal information.</em></li>
        <li><strong>Do we collect any information from third parties?</strong> We may collect information from public databases, marketing partners, social media platforms, and other outside sources. <em>Learn more about information collected from other sources.</em></li>
        <li><strong>How do we process your information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. <em>Learn more about how we process your information.</em></li>
        <li><strong>In what situations and with which types of parties do we share personal information?</strong> We may share information in specific situations and with specific categories of third parties. <em>Learn more about when and with whom we share your personal information.</em></li>
        <li><strong>How do we keep your information safe?</strong> We have adequate organizational and technical processes and procedures in place to protect your personal information. <em>Learn more about how we keep your information safe.</em></li>
        <li><strong>What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. <em>Learn more about your privacy rights.</em></li>
        ...
        <li><strong>Want to learn more about what we do with any information we collect?</strong> Review the Privacy Policy in full.</li>
      </ul>
      ...
      <ol>
        ...
        <h2 class="mb-4">1. WHAT INFORMATION DO WE COLLECT?</h2>
    ...
    <ul>
      <li><strong>Name:</strong> To personalize your shopping experience and fulfill your order.</li>
      <li><strong>Phone Number:</strong> To provide updates on your order and address delivery-related inquiries.</li>
      <li><strong>Email Address:</strong> To send order confirmations, promotional offers, and account-related updates.</li>
      <li><strong>Mailing Address:</strong> To ensure accurate and timely delivery of your purchases.</li>
      <li><strong>Contact Preference:</strong> To communicate with you via your preferred method.</li>
      <li><strong>Username:</strong> To create a unique identity for the user on the platform.</li>
      <li><strong>Password:</strong> To secure user accounts and ensure authorized access.</li>
      <li><strong>Billing Address:</strong> To facilitate payment processing and deliver invoices or billing-related communications.</li>
    </ul>

    <p><strong>Sensitive Information.</strong> We do not process sensitive information.</p>

    <p><strong>Payment Data.</strong> We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by Stripe. You may find their privacy notice link(s) here: <a href="http://www.stripe.com/privacy" target="_blank">http://www.stripe.com/privacy</a>.</p>

    <p>All personal information that you provide to us must be true, complete, and accurate, and you must notify us of any changes to such personal information.</p>

    <h5 class="mt-5">Information automatically collected</h5>
    ...
    <h5 class="mt-5">Information collected from other sources</h5>
  ...
  <h2 class="mb-4">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
    ...
    <h2 class="mt-5 mb-4">3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
    ...
    <p><strong>The categories of third parties we may share personal information with are as follows:</strong></p>
    <ul>
    ...
    <ul>
     ...
     <h2 class="mb-4">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
    ...
    <p>To the extent these online tracking technologies are deemed to be a "sale"/"sharing" (which includes targeted advertising, as defined under the applicable laws) under applicable US state laws, you can opt out of these online tracking technologies by submitting a request as described below under section "WHAT ARE YOUR PRIVACY RIGHTS?"</p>
    ...
    <h2 class="mt-5 mb-4">5. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
    ...
    <h2 class="mt-5 mb-4">6. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
    ...
    <h2 class="mt-5 mb-4">7. DO WE COLLECT INFORMATION FROM MINORS?</h2>
    <p><strong>In Short:</strong> We do not knowingly collect data from or market to children under 13 years of age.</p>

    <p>We do not knowingly collect, solicit data from, or market to children under 13 years of age, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 13 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 13 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under the age of 13, please contact us at <a href="mailto:support@thecanadafoods.com">support@thecanadafoods.com</a>.</p>

    <h2 class="mt-5 mb-4">8. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
    ...
    <h5 class="mt-4">Categories of Personal Information We Collect</h5>
    ...
    <p><strong>Will your information be shared with anyone else?</strong><br>
    We may disclose your personal information with our service providers pursuant to a written contract between us and each service provider. Learn more about how we disclose personal information to in the section, "WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?"</p>
    ...
    <h5 class="mt-4">How to Exercise Your Rights</h5>
    <p>To exercise these rights, you can contact us by emailing us at <a href="mailto:support@thecanadafoods.com">support@thecanadafoods.com</a>, or by referring to the contact details at the bottom of this document.</p>
    ...
    <h5 class="mt-4">Request Verification</h5>
    ...
    <h5 class="mt-4">Appeals</h5>
    <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:support@thecanadafoods.com">support@thecanadafoods.com</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>

    <h5 class="mt-4">California "Shine The Light" Law</h5>
    ...
    <h5 class="mt-4">Withdrawing your consent:</h5>
    ...
    <h5 class="mt-4">Opting out of marketing and promotional communications:</h5>
    ...
    <h5 class="mt-4">Cookies and similar technologies:</h5>
    ...
    <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:support@thecanadafoods.com">support@thecanadafoods.com</a>.</p>

    <h2 class="mt-5 mb-4">9. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
    ...
    <h2 class="mt-5 mb-4">10. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
    ...
    <h2 class="mt-5 mb-4">11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
    <p>If you have questions or comments about this notice, you may email us at <a href="mailto:support@thecanadafoods.com">support@thecanadafoods.com</a>.</p>

    <h2 class="mt-5 mb-4">12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
    <p>Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please email us at: <a href="mailto:support@thecanadafoods.com">support@thecanadafoods.com</a>.</p>
