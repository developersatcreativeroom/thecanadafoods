        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-content">
                    <h2 class="mb-2 text-center">Terms & Conditions</h2>
                    <nav>
...
<section class="">
    ...
    <div class="bg-white p-4 rounded shadow-sm">
      ...
      <h2 class="mt-5">AGREEMENT TO OUR LEGAL TERMS</h2>
      <p>We are Warrior Retail Inc., doing business as The Canada Foods ("Company," "we," "us," "our"), a company registered in Canada.</p>
      <p>We operate the website <a href="https://thecanadafoods.com" target="_blank">https://thecanadafoods.com</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").</p>
      <p>You can contact us by email at <a href="mailto:support@thecanadafoods.com">support@thecanadafoods.com</a>.</p>
      <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Warrior Retail Inc., concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong></p>
      ...
      <p>All third-party product names, logos, brands, and trademarks featured or referred to within our Services are the property of their respective trademark holders. These trademark holders are not affiliated with, nor do they sponsor or endorse, our website, products, or services, unless explicitly stated.</p>
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:support@thecanadafoods.com">support@thecanadafoods.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      ...
      <h2 class="mt-5">3. USER REPRESENTATIONS</h2>
      ...
      <h2 class="mt-5">4. USER REGISTRATION</h2>
      ...
      <h2 class="mt-5">6. PURCHASES AND PAYMENT</h2>
      <p>Following is our payment processor:</p>
      <ul><li>Stripe</li></ul>
      ...
      <h2 class="mt-5">7. RETURN AND REFUND POLICY</h2>
      <p>Please review our Return and Refund Policy posted on the Services [PUT THE LINK TO YOUR RETURN POLICY HERE AFTER YOU UPLOAD THESE POLICIES ON YOUR SITE] prior to making any purchases.</p>

      <h2 class="mt-5">8. PROHIBITED ACTIVITIES</h2>
      ...
      <h2 class="mt-5">9. USER GENERATED CONTRIBUTIONS</h2>
      ...
      <h2 class="mt-5">10. CONTRIBUTION LICENSE</h2>
      ...
      <h2 class="mt-5">11. GUIDELINES FOR REVIEWS</h2>
      ...
      <h2 class="mt-5">12. THIRD-PARTY WEBSITES AND CONTENT</h2>
    ...
    <h2 class="mt-5">13. SERVICES MANAGEMENT</h2>
      ...
      <h2 class="mt-5">14. PRIVACY POLICY</h2>
      <p>We care about data privacy and security. Please review our Privacy Policy: <a href="https://thecanadafoods.com/privacy-policy" target="_blank">https://thecanadafoods.com/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in Canada. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in Canada, then through your continued use of the Services, you are transferring your data to Canada, and you expressly consent to have your data transferred to and processed in Canada.</p>

      <h2 class="mt-5">15. TERM AND TERMINATION</h2>
...
YOUR ACCOUNT AND ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.</p>
      <p>If we terminate or suspend your account for any reason, you are prohibited from registering and creating a new account under your name, a fake or borrowed name, or the name of any third party, even if you may be acting on behalf of the third party. In addition to terminating or suspending your account, we reserve the right to take appropriate legal action, including without limitation pursuing civil, criminal, and injunctive redress.</p>

      <h2 class="mt-5">16. MODIFICATIONS AND INTERRUPTIONS</h2>
      ...
      <h2 class="mt-5">17. GOVERNING LAW</h2>
      <p>These Legal Terms shall be governed by and defined following the laws of Canada. Warrior Retail Inc. and yourself irrevocably consent that the courts of Canada shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>

      <h2 class="mt-5">18. DISPUTE RESOLUTION</h2>
      ...
      <p>Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be one (1). The seat, or legal place, of arbitration shall be Canada. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of Canada.</p>
      ...
      <h2 class="mt-5">21. LIMITATIONS OF LIABILITY</h2>
      ...
      <h2 class="mt-5">22. INDEMNIFICATION</h2>
      ...
      <h2 class="mt-5">25. MISCELLANEOUS</h2>
      ...
      <h2 class="mt-5">26. CONTACT US</h2>
      <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:</p>
      <p><strong>Warrior Retail Inc.</strong><br>
      <strong>Email:</strong> <a href="mailto:support@thecanadafoods.com">support@thecanadafoods.com</a></p>
