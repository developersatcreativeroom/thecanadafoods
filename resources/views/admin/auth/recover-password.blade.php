			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/unitedpalms-1/14.png">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" id="kt_new_password_form" method="POST" action="{{ route('admin.recover.password', [ 'token' => $token ]) }}">
						{{ csrf_field() }}
							<!--begin::Heading-->
							...
							<div class="mb-10 fv-row" data-kt-password-meter="true">
								...
								<div class="mb-1">
									...
									<div class="position-relative mb-3">
										<input class="form-control form-control-lg form-control-solid @if($errors->has('password')) is-invalid @endif" type="password" value="{{ old('password') }}"  placeholder="" name="password" autocomplete="off" />
							...
							<div class="fv-row mb-10">
								...
								<input class="form-control form-control-lg form-control-solid @if($errors->has('password_confirmation')) is-invalid @endif" type="password" placeholder="" name="password_confirmation" value="{{ old('password_confirmation') }}" autocomplete="off" />
