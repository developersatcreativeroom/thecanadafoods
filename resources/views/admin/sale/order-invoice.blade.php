        ...
        <div style="max-width: 780px; text-align: center; float: none; display: inline-block; width: 100%;">
            <table width="100%" class="InvoiceTable" border="0" cellspacing="0" cellpadding="0" style="text-align: left;">
                ...
                <tr>
                    ...
                    <td>
                        <p>Mobile No. : {{App\Helper::makePhonesText(config('constants.CONTACT.country_code'), config('constants.CONTACT.phone'))}}</p>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="text-align: left;">
                        <tr>
                          <td>                                    
                              <h6>Sold To:</h6>
                              <p>
                                <strong>Name:</strong> {{$row->billing->first_name}} {{$row->billing->last_name}}
                              </p>
                              <p>
                                <strong>Email:</strong> {{$row->billing->email}}
                              </p>
                              <p>
                                <strong>Phone:</strong> {{$row->billing->phone}}
                              </p>
                              @if($row->billing->company_name)
                              <p>
                                <strong>Company Name:</strong> {{$row->billing->company_name}}
                              </p>
                              @endif
                              ...
                              <p>
                                ...
                                {{$row->billing->state}} {{$row->billing->country}} 
                              </p>
                          ...
                          @if($row->shipping)
                            <td>                                    
                                <h6>Shipped To:</h6>
                                <p>
                                    <strong>Name:</strong> {{$row->shipping->first_name}} {{$row->shipping->last_name}}
                                </p>
                                <p>
                                    <strong>Email:</strong> {{$row->shipping->email}}
                                </p>
                                <p>
                                ...
                                <p>
                                    <strong>Company Name:</strong> {{$row->shipping->company_name}}
                                </p>
                                @endif
                                ...
                                <p>
                                    ...
                                    {{$row->shipping->state}} {{$row->shipping->country}} 
                                </p>
                            </td>
                          @endif
                          <td>
                              <!-- <h1>{{ ($row->payment_method == "instamojo") ? "Instamojo" : 'COD' }} Order</h1> -->
                              <h1>Order</h1>
                              <p><strong>Order ID: </strong>{{$row->order_no}}</p>
                              <p><strong>Order Date: </strong>{{$row->created_at?->format(App\Helper::universalDateTimeFormat()) ?? ''}}</p>
                              @if($row->status)
                              <p><strong>Sub-total: </strong>{{$row->currency}}{{$row->payment->total}}</p>   
                              @endif
                              @if($row->customer_gst)
                              <p><strong>Customer GST: </strong>{{$row->customer_gst}}</p>   
                              @endif
                              @if($row->local_pickup)
                            ...
                            <tbody>
                                ...
                                @foreach($row->products as $key => $product)
                                    <tr>
                                        ...
                                        <td>{{$row->currency}}{{App\Helper::numberFormat($product->old_price-$product->price)}}</td>
                                        <td>{{$product->sku}}</td>
