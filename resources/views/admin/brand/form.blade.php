          ...
          <div class="col-md-12">
            ...
            <div class="card">
			  <div class="card-header d-flex justify-content-between p-0">
                <h3 class="card-title p-3">Brand details</h3>
				        <div class="ml-auto py-2 px-3"><a class="btn btn-primary" href="{{route('admin.brands')}}">List</a></div>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              {{-- @if(!empty($row) && ($row->image != null || $row->image != '' ))
                <div class="form-group">
                  <div class="form-row">
                    <div class="col-md-4">
                      <img class="img-fluid img-thumbnail" src="{{ asset('storage/brands/') }}/{{$row->id}}/{{$row->image}}" />
                    </div>
                  </div>
                </div>
              @endif --}}
