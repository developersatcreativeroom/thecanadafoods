                                ...
                                <tr>
                                    <td style="width: 100%;">
                                        <div class="text" style="padding: 0 2.5em; text-align: center;">
                                            ...
                                            <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;">Hey <span>{{$name}}</span>,<br />Thanks for registering with <span>{{config('constants.BUSINESS.name')}}</span>.<br /> Your account information is as below :-</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
