                                ...
                                <tr>
                                    <td style="width: 100%;">
                                        <div class="text" style="padding: 0 2.5em; text-align: center;">
                                            ...
                                            <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;">Hey <span>Admin</span>,<br />There is new order with order number <strong>{{$order_no}}</strong> at <span>{{config('constants.BUSINESS.name')}}</span>.<br /> The user account information is as below :-</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
