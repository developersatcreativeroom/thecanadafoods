                                ...
                                <tr>
                                    <td style="width: 100%;">
                                        <div class="text" style="padding: 0 2.5em; text-align: center;">
                                            ...
                                            <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;">Hey <span>Admin</span>,<br />Here is a contact form filled by a user at <span>{{config('constants.BUSINESS.name')}}</span>.<br /> The details are as below :-</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td class="bg_white" style="padding: 5px 25px; width: 100%;">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td style="width: 50%">
                                        <p style="float: left; width: 100%; text-align: right; line-height: 1; color: #acacac; margin-bottom: 0; line-height: 1 padding: 0">
                                            <span style="color: #acacac"> {{$subject}} </span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td class="bg_white" style="padding: 5px 25px; width: 100%;">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td style="width: 50%">
                                        <p style="float: left; width: 100%; text-align: right; line-height: 1; color: #acacac; margin-bottom: 0; line-height: 1 padding: 0">
                                            <span style="color: #acacac"> {{$user_message}} </span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
