                                ...
                                <tr>
                                    <td style="width: 100%;">
                                        <div class="text" style="padding: 0 2.5em; text-align: center;">
                                            ...
                                            <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;">Hey <span>{{$name}}</span>,<br />The status of your order number <strong>{{$order_no}}</strong> is changed to  <strong>{{$status}}</strong> at <span>{{config('constants.BUSINESS.name')}}</span>.</p>
                                        </div>
                                    </td>
                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 50%">
                                                        <p style="float: left; width: 100%; text-align: right; line-height: 1; color: #acacac; margin-bottom: 0; line-height: 1 padding: 0">
                                                            <span style="color: #acacac"> {{$note}} </span>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
