            ...
            <div style="max-width: 600px; margin: 0 auto; width: 100%; background-color: #fff;" class="email-container">
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                                ...
                                <tr>
                                    <td style="width: 100%;">
                                        <div class="text" style="padding: 0 2.5em; text-align: center;">
                                            ...
                                            <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;">Hey <span>{{$name}}</span>,<br />Thanks for placing an enquiry with transaction number <strong>{{$enquiry_no}}</strong> at <span>{{config('constants.BUSINESS.name')}}</span>.<br /> Your account information is as below :-</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <td class="bg_white" style="padding: 5px 25px; width: 100%;">
                        ...
                        <td style="text-align: left; color: #acacac;">{{$enquiry->currency}}{{$product->sale_price}}</td>
                        <td style="text-align: left; color: #acacac;">{{$enquiry->currency}}{{App\Helper::numberFormat($product->old_price-$product->price)}}</td>
                        <td style="text-align: left; color: #acacac;">{{$product->sku}}</td>
                      
                        <!-- <td style="text-align: left; color: #acacac;">{{$product->tax}}%</td> -->
                        <td style="text-align: left; color: #acacac;">{{$enquiry->currency}}{{$product->tax_value}}</td>
                        <!-- <td style="text-align: left; color: #acacac;">{{$product->brand_name}}</td> -->
                        <td style="text-align: left; color: #acacac;">{{$enquiry->currency}}{{App\Helper::numberFormat($product->final_price * $product->quantity )}}</td>
                        </table>
                        </td>
                    </tr>
