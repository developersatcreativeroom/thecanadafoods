    ...
    public function postData(Request $request){
        ...
        //if(empty($id)){
            $validationArray=array(
                ...
                'hover_image'=>'mimes:jpeg,jpg,png,webp',
                //'sku'=>'required',
                // 'price'=>'required',
                // 'old_price'=>'required',
                'tax_id'=>'required',
            ...
            if($isVariant == 'on'){
                ...
                $validationArray['attributes.*.hover_image']='mimes:jpeg,jpg,png,webp';
            ...
            if(empty($id)){
                ...
                $validationArray['attributes.*.image']='mimes:jpeg,jpg,png,webp';
