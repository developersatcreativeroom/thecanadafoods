(jQuery,
    $(document).ready(function () {
        ...
        function renderCartButtonsHtml(
            event,
            that,
            page,
            update_html = null,
            ...
            ("add" == event &&
                ("list" == page &&
                    that
                        .find("i")
                        .addClass("fi-rs-trash")
                        .removeClass("fi-rs-shopping-bag-add"),
                "detail" == page &&
                    $(".remove-service, .add-service").length > 0 &&
                    $(".remove-service, .add-service").prop("disabled", !1),
                "wishlist" == page &&
                    (wishlistCount > 0
                        ? that.closest("tr").remove()
                        : (that
                              .closest(".wishlist-table")
                              .after(
                ...
                "delete" == event &&
                    ("list" == page &&
                        (that.text(
                            null != update_html ? update_html : "Add to Cart",
                        ),
                        that.addClass("add-cart").removeClass("delete-cart"),
                        that
                            .find("i")
                            .addClass("fi-rs-shopping-bag-add")
                            .removeClass("fi-rs-trash")),
                    "detail" == page &&
                        (that.addClass("add-cart").removeClass("delete-cart"),
                        that.text(
                            null != update_html ? update_html : "Add to cart",
                        ...
                        $(".remove-service, .add-service").length > 0 &&
                            ($(".remove-service, .add-service").prop(
                                "disabled",
                                !0,
                            ),
                            ...
                            $(".service")
                                ...
                                .addClass("add-service"),
                            $(".addon").text("Add Addon"),
                            $(".addon")
                                .removeClass("remove-addon")
                                .addClass("add-addon")))));
        }
        (cartCount(),
            $.ajax({
            ...
            $("body").on("click", ".add-cart", function () {
                ...
                var quantity = that
                    ...
                    .find(".qty-val")
                    .val();
                ((void 0 !== quantity && "" != quantity && null != quantity) ||
                    (quantity = 1),
                    (quantity = parseInt(quantity)));
                var attribute = null;
                return (
                    $("#attribute_id").length > 0 &&
            ...
            $("body").on("click", ".delete-cart", function () {
                var that = $(this),
                    ...
                    attribute = null;
                return (
                    that.closest("tr").find('[name="product_attribute"]')
                        .length > 0 &&
                        (attribute = that
                            .closest("tr")
                            .find('[name="product_attribute"]')
                            .val()),
                    that.attr("data-attribute") &&
                        (attribute = that.attr("data-attribute")),
                    $("#attribute_id").length > 0 &&
                        (attribute = $("#attribute_id").val()),
                    $(".loader").removeClass("d-none"),
                        ...
                        success: function (response) {
                            if (
                                ...
                                return (
                                    ...
                                    $("#checkout-section").length > 0 &&
                                        $("#products-section").length > 0 &&
                                        (0 == response.count &&
                                            location.reload(),
                                        $("#checkout-section").html(
                                            response.checkoutHtml,
                                        ),
                                        $("#products-section").html(
                                            response.productsHtml,
                                        )),
            ...
            $("body").on("click", ".change-qty", function () {
                var that = $(this),
                    quantity = parseInt(
                        that.closest(".detail-qty").find(".qty-val").val(),
                        10,
                    );
            ...
            $("body").on("focusout", ".product-qty-val", function () {
                var that = $(this),
                    quantity = parseInt(that.val(), 10),
                    stock = that
                        .closest(".detail-qty")
                        .find(".qty-up.change-qty")
                        .attr("data-stock");
                return (
                    quantity <= 0 && ((quantity = 1), that.val(quantity)),
                    null != stock &&
                        "" != stock &&
                        quantity > stock &&
                        ((quantity = stock), that.val(quantity)),
                    !1
                );
            }),
            $("body").on("focusout", ".update-cart-input", function () {
                ...
                (quantity <= 0 && ((quantity = 1), that.val(quantity)),
                    null != stock &&
                        ...
                        ((quantity = stock), that.val(quantity)));
                var attribute = null;
                (that.closest("tr").find('[name="product_attribute"]').length >
                    0 &&
                    (attribute = that
                        .closest("tr")
                        .find('[name="product_attribute"]')
            ...
            $("body").on("click", ".update-cart", function () {
                var that = $(this);
                if (that.is(":disabled")) return (console.log("disabled"), !1);
            ...
            $("body").on("click", ".add-wishlist", function (e) {
                var that = $(this),
                    key = that.attr("data-key");
                if (that.hasClass("disabled")) return !1;
                var attribute = null;
                return (
                    $("#attribute_id").length > 0 &&
                        (attribute = $("#attribute_id").val()),
        ...
        ($("body").on("click", ".attribute-option", function () {
            var that = $(this);
            ($("#attribute-selected-error").text(""),
                that.closest("li").hasClass("non-available") &&
                    ($(".attributes")
                        .find(".attribute-select")
                        .find(".attribute-option")
                        .closest("li")
                        .removeClass("non-available"),
                    $(".attributes")
                        .find(".attribute-select")
                        .find(".attribute-option")
                        .closest("li")
            ...
            return (
                that
                    ...
                    .find(".attribute-select")
                    .each(function () {
                        var attributeCurrent = $(this)
                                .closest(".attribute-select")
                                .attr("data-attribute"),
                            attributeCurrentValue = $(this)
                                .find("li.active")
                                .find(".attribute-option")
                                .attr("data-id");
                        void 0 !== attributeCurrentValue &&
                            (selectedValues[attributeCurrent] =
                    ...
                    success: function (response) {
                        ($(".loader").addClass("d-none"),
                            ...
                            response.result
                                ? response.stock > 0
                                    ? ($(".price").text(response.price),
                                      response.old_price
                                          ...
                                          : $(".old-price").text(""),
                                      $(".add-cart").prop("disabled", !1),
                                      $(".add-cart").removeClass("disabled"),
                                      $(".add-wishlist").prop("disabled", !1),
                                      $(".add-wishlist").removeClass(
                                          "disabled",
                                      ),
                                      response.already_in_wishlist
                                          ? $(".add-wishlist").addClass(
                                                "active",
                                            )
                                          : $(".add-wishlist").removeClass(
                                                "active",
                                      ...
                                      null != response.image &&
                                          ...
                                          $(".product-image-thumb").attr(
                                              "src",
                                              response.image,
                                          )),
                                      null != response.hover_image &&
                                          ($(".product-image-hover").attr(
                                              "src",
                                              response.hover_image,
                                          ),
                                          $(".product-image-thumb-hover").attr(
                                              "src",
                                              response.hover_image,
                                          )),
                                      (null == response.image &&
                                ...
                                : (renderCartButtonsHtml(
                                      "delete",
                                      $(".product-detail").find(".delete-cart"),
                                      "detail",
                                      null,
                                      null,
                                  ),
            ...
            $("body").on("click", ".add-addon", function () {
                $(this);
                return (alert("addon"), !1);
            }),
            $("body").on("click", ".add-service", function () {
                var that = $(this),
                    key = that.attr("data-key"),
                    service = that.attr("data-service"),
                    attribute = null;
                return (
                    $("#attribute_id").length > 0 &&
                        (attribute = $("#attribute_id").val()),
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (
                                ...
                                return (
                                    that
                                        .removeClass("add-service")
                                        .addClass("remove-service"),
            ...
            $("body").on("click", ".change-address", function (e) {
                ...
                return (
                    ...
                    $("#changeAddressModal")
                        .find(".addresses")
                        .html('<p class="text-center my-4">Loading...</p>'),
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            (console.log(response),
                                ...
                                $("#place-order-section").html(
                                    response.place_order_html,
                                ),
                                $("#local-pickup").is(":checked") &&
                                    $("#shipping-user-address").addClass(
                                        "d-none",
                                    ),
                ...
                return (
                    1 == that.attr("data-is-default") ||
                        $.ajax({
                            ...
                            success: function (response) {
                                response.result &&
                                    ($(".set-default-address").html(
                                        "Set Default",
                                    ),
                                    $(".set-default-address").attr(
                                        "data-is-default",
                                        0,
                                    ),
                                    that.html("Default"),
            ...
            $(".tab-select.active").length > 0 &&
                tabSelectProducts(
                    $(".tab-select.active").attr("data-category"),
                ),
            $("body").on("click", ".tab-select", function (e) {
                var that = $(this);
                (tabSelectProducts(that.attr("data-category")),
        ...
        function addFiltersToUrl(ignore = null) {
            ...
            if (
                ...
                ($("#filters").find(".category:checked").length > 0 &&
                    countFilters++,
                    $("#filters")
                        .find(".category:checked")
                        .each(function () {
                            categories.push($(this).val());
                        }),
                    $("#categories-modal-list")
                        .find(".category-modal:checked")
                        .each(function () {
                            categories.push($(this).val());
                        }));
            ...
            if (
                ("colors" != ignore &&
                    ($("#filters").find(".color:checked").length > 0 &&
                        countFilters++,
                    $("#filters")
                        .find(".color:checked")
                        .each(function () {
                ...
                ($("#filters").find(".brand:checked").length > 0 &&
                    countFilters++,
                    $("#filters")
                        .find(".brand:checked")
                        .each(function () {
            ...
            if (
                ...
                window.location.href =
                    window.location.origin + rootPathname + "?" + str;
            } else window.location.href = window.location.pathname;
        }
        ($("[data-smart-search]")
            .typeahead(
                { hint: !1, highlight: !0, minLength: 1 },
                {
                    name: "smart_search",
                    limit: 50,
                    display: "name",
                    ...
                    templates: {
                        ...
                        suggestion: function (data) {
                            return (
                                '<a class="searchItemWrap" href="' +
                                data.link +
                                '" target="_blank"><div class="image-section"><img src="' +
                                data.image +
                                '" alt="Prduct Image" /></div><div class="description-section"><div class="fullWidth"><h1>' +
                                data.name +
                                "</h1><p> " +
                                data.price +
                                '</p></div></div></div><div class="clearfix"></div></a>'
                            );
                        },
                        footer: [
                            '<div class="searchItemWrap searchTrigger text-center"><div class="empty-message"><a href="' +
                                site_url +
                                '/products" target="_blank">View All</a></div></div>',
                        ],
                    },
                },
            )
            ...
            $("body").on("click", "#filters .color", function () {
                ($(this).toggleClass("active"), addFiltersToUrl());
            }),
        ...
        $(function () {
            var minVal = parseInt(sliderrange.attr("data-min")),
                maxVal = parseInt(sliderrange.attr("data-max")),
                minValSelected = parseInt(
                    sliderrange.attr("data-min-selected"),
                ),
                maxValSelected = parseInt(
                    sliderrange.attr("data-max-selected"),
                );
            (sliderrange.slider({
                range: !0,
                min: minVal,
        ...
        var selectedState,
            ...
            keyword = urlParams.getAll("keyword").toString(),
            categoriesUrlArray = urlParams
                .getAll("categories")
                .toString()
                .split(","),
            colorsUrlArray = urlParams.getAll("colors").toString().split(","),
            brandUrlArray = urlParams.getAll("brands").toString().split(","),
            sortUrl = urlParams.getAll("sort").toString();
        function showShippingFields(pageLoad = null) {
            ($("#differentaddress").is(":checked")
                ? ($("#collapseAddress").addClass("d-none"),
                  $("#collapseAddress")
                      .find("input,select")
                      .prop("disabled", !0),
                  $("#collapseAddress")
                      .find("input:not(.optional), select:not(.optional)")
                      .prop("required", !1))
                : ($("#collapseAddress").removeClass("d-none"),
                  ...
                  $("#collapseAddress")
                      .find("input:not(.optional), select:not(.optional)")
                      .prop("required", !0)),
                pageLoad || resetAddressValidation());
        }
        ...
        function removeCouponHtml() {
            $("#coupon-cont").html(
                '<h4 class="checkout-voucher-title mb-3">Have a coupon?</h4>                                <div class="d-flex align-items-center">                                    <input type="text" placeholder="Enter Your Coupon" class="theme-input w-100" name="Coupon" id="coupon-code">                                    <button type="submit" class="btn btn-secondary flex-shrink-0" id="apply-coupon">Apply Coupon</button>                                </div>                                <div id="coupon-message"></div>',
            );
        }
                ...
                parentBody.find("input,textarea,select").each(function () {
                    if (
                        ...
                        ((name = name.replace(/_/g, " ")),
                            $(this).after(
                                '<div class="invalid-feedback">The ' +
                                    name +
        ...
        function validateEmailFormat(emailObj) {
            var flag = !0;
            return (
                validateEmail(emailObj.val())
                    ? (emailObj.removeClass("is-invalid"),
                      $(this).find(".invalid-feedback").remove())
                    : (emailObj.addClass("is-invalid"),
                      emailObj.after(
                          '<div class="invalid-feedback">The valid email address is required.</div>',
                      ),
                      (flag = !1)),
                flag
            );
        ...
        function validateAfterCall(responseText, form) {
            $.isEmptyObject(responseText.errors) ||
                form.find("input,textarea,select").each(function () {
                    var key = $(this).attr("name");
                    key in responseText.errors &&
                        (form
                            .find(
                                'textarea[name="' +
                                    key +
        ...
        function customerGST() {
            ...
            "Distributor" == orderType || "Commercial" == orderType
                ? ($('input[name="customer_gst"]')
                      .closest(".form-group")
                      .removeClass("d-none"),
                  $('input[name="customer_gst"]').prop("disabled", !1))
                : ($('input[name="customer_gst"]')
                      .closest(".form-group")
                      .addClass("d-none"),
                  $('input[name="customer_gst"]').prop("disabled", !0));
        }
        function localPickup() {
            if ($("#local-pickup").length > 0) {
                var total = $("#total").attr("data-value"),
                    shipping = $("#shipping").attr("data-value");
                ((total = parseFloat(total)),
                    ...
                    $("#local-pickup").is(":checked")
                        ? ($("#total").text(
                              site_currency +
                                  "" +
                                  priceFormat(total - shipping),
                          ),
                          $("#shipping").closest("tr").addClass("d-none"),
                          $("#differentaddress").is(":checked") &&
                              ($("#differentaddress").prop("checked", !0),
                              showShippingFields()),
                          $("#differentaddress")
                              .closest(".form-group")
                              .removeClass("d-none"),
                        ...
                        : ($("#total").text(
                              site_currency + "" + priceFormat(total),
                          ),
        ...
        function getStates(countryObj, stateObj) {
            ...
            if ("" == country || null == country) return (stateObj.val(""), !1);
            ($(".loader").removeClass("d-none"),
                $.ajax({
                    type: "GET",
                    headers: {
                    ...
                    success: function (response) {
                        if (
                            ...
                            var selectedState = stateObj.attr(
                                "data-selected-state",
                            );
                            return (
                                void 0 !== selectedState &&
                                    "" != selectedState &&
                                    $(
                                        "#state option[value='" +
                                            selectedState +
        ...
        function resetAddressValidation() {
            ...
            ((total = parseFloat(total)),
                (shipping = parseFloat(shipping)),
                $("#total").text(
                    site_currency + "" + priceFormat(total - shipping),
                ),
                $("#total").attr("data-value", parseFloat(total - shipping)),
                $("#shipping").text(site_currency + "" + priceFormat(0)),
                $("#shipping").attr("data-value", 0),
                $(".place-order-cont").html(
                    '<p class="text-danger mb-0"><small>*Please fill in valid address details first </small></p><a disabled class="btn btn-primary btn-md rounded w-100 text-white disabled" >Place Order</a>',
                ),
                $("#differentaddress").is(":checked")
                    ? ($("#state-billing").val(""), $("#state").val(""))
                    : $("#state-billing").val(""));
        }
        function getStateShipping(stateObj) {
            let state = stateObj.find(":selected").val();
            ((void 0 !== state && "" != state && null != state) ||
        ...
        function applyPricingResponse(response) {
            if (
                ...
                response.checkout.shipping_data.result)
            ) {
                var noPaymentMethodCount = $(".place-order-cont").find(
                        "a.no-payment-method",
                    ).length,
                    noUserAddressCount =
                        $(".place-order-cont").find("a.no-user-address").length;
                noPaymentMethodCount <= 0 &&
                    noUserAddressCount <= 0 &&
                    $(".place-order-cont").html(
                ...
                $(".place-order-cont").html(
                    '<p class="text-danger mb-0"><small>*' +
                        response.checkout.shipping_data.message +
                        ' </small></p><a disabled class="btn btn-primary btn-md rounded w-100 text-white disabled" >Place Order</a>',
                );
        }
        function toggleStateRequiredForExpress() {
            var $state = $("#state");
            $state.length &&
                (isExpressMethodValue(
                    $('input[name="shipping_method"]:checked').val(),
                )
        ...
        function isExpressMethodValue(value) {
            return (
                String(value) === String($("#shipping-method-express").val())
            );
        }
        ...
        function refreshCheckoutPricing(method) {
            ((method =
                ...
                standardMethodValue()),
                $("#state").length
                    ? (isExpressMethodValue(method) || $("#state").val()) &&
        ...
        ($("#filters").find("#keyword").val(keyword),
            $("#filters")
                ...
                .each(function () {
                    ...
                    -1 != $.inArray(valueCategory, categoriesUrlArray) &&
                        (console.log($(this)), $(this).prop("checked", !0));
                }),
            $("#categories-modal-list")
                .find(".category-modal")
                .each(function () {
            ...
            $("#filters")
                ...
                .each(function () {
                    ...
                    -1 != $.inArray(valueColor, colorsUrlArray) &&
                        $(this).prop("checked", !0);
                }),
            $("#filters")
                .find(".brand")
                .each(function () {
                    ...
                    -1 != $.inArray(valueBrand, brandUrlArray) &&
                        $(this).prop("checked", !0);
                }),
            $("#filters")
                .find(".brand-modal")
            ...
            void 0 !== sortUrl && "" != sortUrl && $(".sort").val(sortUrl),
            $("body").on("change", "#differentaddress", function () {
                showShippingFields(!0);
            }),
            showShippingFields(!0),
            $("body").on("click", "#apply-coupon", function () {
                ...
                var code = $("#coupon-code").val(),
                    stateCode = "";
                return "" == $("#coupon-code").val() ||
                    null == $("#coupon-code").val()
                    ? ($("#coupon-code").addClass("is-invalid"),
                      $("#coupon-message").html(
                          '<p class="text-danger">Please enter the coupon code.</p>',
                      ),
                      !1)
                    : ($("#coupon-code").removeClass("is-invalid"),
                      $("#coupon-message").html(""),
                      $("#state").length > 0 && (stateCode = $("#state").val()),
                      $.ajax({
                          type: "POST",
                          headers: {
                              "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr(
                          ...
                          success: function (response) {
                              (response.result
                                  ? (toastr.success(
                                    ...
                                    (function (code) {
                                        $("#coupon-cont").html(
                                            '<div class="coupon-applied">                                    <span class="coupon-applied-icon"><i class="fas fa-tag"></i></span>                                    <span class="coupon-applied-body">                                        <span class="coupon-applied-code">' +
                                                code +
                                                '</span>                                        <span class="coupon-applied-label">Coupon applied</span>                                    </span>                                    <button type="button" class="coupon-applied-remove" id="remove-coupon" data-code="' +
                                                code +
                                                '">                                        <i class="fas fa-xmark"></i> Remove                                    </button>                                </div>',
                                        );
                                    })(code),
                                    $("#checkout-section").html(
                                        response.checkoutHtml,
            ...
            $("body").on("click", "#save-address", function (e) {
                var that = $(this),
                    modalBody = $("#addressModal").find(".modal-body");
                (modalBody.find("input").removeClass("is-invalid"),
                    modalBody.find(".invalid-feedback").remove());
                if (!validateEmptyFields(modalBody)) return !1;
                if (!validateEmailFormat(modalBody.find('input[name="email"]')))
                    return !1;
                var first_name = modalBody
                        .find('input[name="first_name"]')
                        .val(),
                    last_name = modalBody.find('input[name="last_name"]').val(),
                    company_name = modalBody
                        .find('input[name="company_name"]')
                        .val(),
                    email = modalBody.find('input[name="email"]').val(),
                    phone = modalBody.find('input[name="phone"]').val(),
                    address_line_1 = modalBody
                        .find('input[name="address_line_1"]')
                        .val(),
                    address_line_2 = modalBody
                        .find('input[name="address_line_2"]')
                        .val(),
                    street = modalBody.find('input[name="street"]').val(),
                    city = modalBody.find('input[name="city"]').val(),
                    state = modalBody.find('select[name="state"]').val(),
                    country = modalBody.find('select[name="country"]').val(),
                    postal = modalBody.find('input[name="postal"]').val(),
                    id = modalBody.find('input[name="id"]').val();
                return (
                    that.prop("disabled", !0),
                ...
                ($("#changeAddressModal").modal("hide"),
                    setTimeout(() => {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if ((console.log(response), response.result)) {
                                    var modalBody =
                                        $("#addressModal").find(".modal-body");
                                    (modalBody
                                        .find('input[name="first_name"]')
                                        .val(response.address.first_name),
                                        modalBody
                                            .find('input[name="last_name"]')
                                            .val(response.address.last_name),
                                        modalBody
                                            .find('input[name="company_name"]')
                                            .val(response.address.company_name),
                                        modalBody
                                            .find('input[name="email"]')
                                            .val(response.address.email),
                                        modalBody
                                            .find('input[name="phone"]')
                                            .val(response.address.phone),
                                        modalBody
                                            .find(
                                                'input[name="address_line_1"]',
                                            )
                                            .val(
                                                response.address.address_line_1,
                                            ),
                                        modalBody
                                            .find(
                                            ...
                                            .val(
                                                response.address.address_line_2,
                                            ),
                                        modalBody
                                            .find('input[name="street"]')
                                            .val(response.address.street),
                                        modalBody
                                            .find('input[name="city"]')
                                            .val(response.address.city),
                                        modalBody
                                            .find('select[name="country"]')
                                            .val(response.address.country),
                                        modalBody
                                            .find('select[name="state"]')
                                            .val(response.address.state),
                                        modalBody
                                            .find('input[name="postal"]')
                                            .val(response.address.postal),
                                        modalBody
                                            .find('input[name="id"]')
                                            .val(key),
                                        $("#addressModal").modal("show"));
            ...
            $("body").on("click", "#submit-review", function (e) {
                ...
                if (
                    ...
                    !validateEmailFormat(form.find('input[name="email"]')))
                )
                    return !1;
                var key = that.attr("data-key"),
            ...
            $("body").on("change", "#state", function (e) {
                ...
                if ("" == that.val() || null == that.val())
                    return (
                        that.hasClass("get-shipping") &&
                            resetAddressValidation(),
                        !1
                    );
                that.hasClass("get-shipping") && getStateShipping(that);
            }),
            void 0 !==
                (selectedState = $("#state").attr("data-selected-state")) &&
                "" != selectedState &&
                null != selectedState &&
                getStateShipping($("#state")),
            ...
            $("body").on("click", ".show-add-payment-method", function (e) {
                $(this);
                return ($("#addPaymentMethodModal").modal("show"), !1);
            }),
            (toastr.options = {
                closeButton: !1,
                debug: !1,
